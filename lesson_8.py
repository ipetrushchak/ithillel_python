...
a = intro(Firstname="Sita", Lastname="Sharma", Age=22, Phone=1234567890)

b = intro(Firstname="John", Lastname="Wood", Email="johnwood@nomail.com", Country="Wakanda", Age=25, Phone=9876543210)
final_dict = a | b
final_dict.update(b)
print(final_dict)
# =================== Lambda
